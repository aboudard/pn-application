...
export class MetaProductionComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-meta-production div table .btn-danger'));
  title = element.all(by.css('jhi-meta-production div h2#page-heading span')).first();
...
export class MetaProductionUpdatePage {
  pageTitle = element(by.id('jhi-meta-production-heading'));
...
export class MetaProductionDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-metaProduction-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-metaProduction'));
