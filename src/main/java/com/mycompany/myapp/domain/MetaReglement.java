 ...
 */
@Entity
@Table(name = "meta_reglement")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class MetaReglement implements Serializable {
    ...
    public MetaReglement idTech(Long idTech) {
        this.idTech = idTech;
        return this;
    }
    ...
    public MetaReglement societe(String societe) {
    ...
    public MetaReglement numSinistre(String numSinistre) {
    ...
    public MetaReglement numContratLgbt(String numContratLgbt) {
    ...
    public MetaReglement numSous(String numSous) {
    ...
    public MetaReglement idTech(Demande demande) {
        this.idTech = demande;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MetaReglement)) {
            return false;
        }
        return id != null && id.equals(((MetaReglement) o).id);
    }
